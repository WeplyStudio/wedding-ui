      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          <Link href="#home" className="flex items-center gap-2" aria-label="Back to top">
            ...
            <span className="font-headline text-2xl text-primary font-bold hidden sm:inline">Evergreen Vows</span>
          </Link>
          ...
          <div className="md:hidden">
            <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
              ...
              <SheetContent side="right" className="w-[300px] sm:w-[300px] bg-background">
